...
2. Create a new stack using the following S3 URL as a template source - [https://privo-hail.s3.amazonaws.com/quickstart-hail/templates/hail-master.yaml](https://privo-hail.s3.amazonaws.com/quickstart-hail/templates/hail-master.yaml)
